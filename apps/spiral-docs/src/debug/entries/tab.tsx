...
import { spiralHasTab, Tab as TabMaybe, TabItem as TabItemMaybe } from "../../lib/spiral-optional";
import {
...
): DebugComponentEntry<TabDebugState> {
  return {
    id: "tab",
    label: "Tab",
    ...
    nodes: [
      {
        ...
        applyOverride: (state, value: KnobValues) => ({
          ...
          style: String(value.style ?? "default") as TabDebugState["style"],
          background: String(value.background ?? "none") as TabDebugState["background"],
...
export const tabEntry: DebugComponentEntry<TabDebugState> | null =
  spiralHasTab && TabMaybe && TabItemMaybe
    ? buildTabEntry(TabMaybe, TabItemMaybe)
    : null;
